<?php
        require_once('./tpl_navbar_head.php');
    ?> 
...
@media screen and (max-width:767px){
  ...
  <body>
    ...
    <nav class="j-nav">
    <?php
    require_once('./tpl_navbar_html.php');
    ...
    <header class="hp-banner">
        ...
        <!-- LOGO -->
         <img data-tilt src="images/logo.png" alt="" class="hp-logo">
        <img data-tilt src="images/logo.png" alt="" class="hp-logo logo_shadow">
    </header>
    ...
    <div class="container">
        ...
        <div class="hp-newProductSection">
                <div class="row hp-titleGroup">
                    ...
                    <div class="col-lg-2 col-4">
                        <div class="title hp-title text-center">熱門商品
                            <img src="images/title.svg" alt="" class="hp-titlePic">
                        </div>
                    </div>
                    <div class="col-lg-5 col-4">
...
<!-- 商品顯示排版 -->
    ...
    <script src="./tpl_navbar_js.js"></script>
    ...
    <script src="./lib/tilt.js-master/dest/tilt.jquery.js"></script>
