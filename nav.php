    ...
    <div class="nav-bar nav-re col-sm-12">
        ...
        <div class="container  ">
            <div class=" pc-nav row col-xs-12 ">
                <div class="nav-logo "><a href=""><img src="images/logo.svg" alt=""></a></div>
                <ul class="nav-ul black">
                    <li class="nav-li liahs nav-liss  ">
                        <a class="black nav-list navliajq " href="">商品列表</a> </li>
                    <li class="nav-li liah"><a class="black " href="">DIY你的滑板</a></li>
                    <li class="nav-li liah nav-lis"><a class="black" href="">最新消息</a></li>
                    <li class="nav-li liah nav-lis"><a class="black" href="">新手指南</a></li>
...
<!-- /會員Icon ------------------------------------------------------------------------->
                    <li class="nav-right-li  circle-num-pos"><a href="#" class="">
                ...
                <div class="nav-hover-list col-sm-12 col-xl-12 bg-g3 ">
                    <div class="tip d-flex container ">
                        <div class="navdivw2 d-flex navcor ndivmar mnavtit ">
                            <a href="" class="white navaapad navpcla2 navulrightborder  ">最新商品</a>
                            <a href="" class="white navaapad navpcla2 navulrightborder">人氣商品</a>
                        </div>
                        ...
                        <div class="navdivw3  navco d-flex ndivmar justify-content-center">
                            ...
                            <div class="">
                                <ul class="tip navulw navulleftborder white ">
                                    <li><a href="" class="white navpcla">Almost</a></li>
                                    <li><a href="" class="white navpcla">DGK</a></li>
                                    <li><a href="" class="white navpcla">Enjoi</a></li>
                                    <li><a href="" class="white navpcla">Independent</a></li>
                                    <li><a href="" class="white navpcla">Krux</a></li>
                                </ul>
                            </div>
                            <div>
                                <ul class="tip navulw  white ">
                                    <li><a href="" class="white navpcla">Penny</a></li>
                                    <li><a href="" class="white navpcla">RIPNDIP</a></li>
                                    <li><a href="" class="white navpcla">Santa Cruz</a></li>
                                    <li><a href="" class="white navpcla">Spitfire</a></li>
                                    <li><a href="" class="white navpcla">Toy Machine</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="navdivw navco d-flex ndivmar ">
                            <div class="d-flex ">
                                <a href="" class="white navpcla2 pccccc2 ">交通板</a>
                            </div>
                            <div>
                                <ul class="tip navulw navulleftborder white ">
                                    <li class="navulwli2"><a href="" class="white navpcla ">23" 以下</a></li>
                                    <li class="navulwli2"><a href="" class="white navpcla ">24" ~ 26"</a></li>
                                    <li class="navulwli2"><a href="" class="white navpcla ">27" ~ 29"</a></li>
                                    <li class="navulwli2"><a href="" class="white navpcla ">30" 以上</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="navdivw navco d-flex ndivmar ">
                            <div class="d-flex ">
                                <a href="" class="white navpcla2 pccccc ">板身</a>
                            </div>
                            <div>
                                <ul class="tip navulw navulleftborder white ">
                                    <li class="navulwli2"><a href="" class="white navpcla ">23" 以下</a></li>
                        ...
                        <div class="navdivw navco d-flex ndivmar">
                            <div class="d-flex ">
                                <a href="" class="white navpcla2 pccccc ">輪架</a>
                            </div>
                            <div>
                                <ul class="tip navulw navulleftborder white ">
                                    <li class="navulwli2"><a href="" class="white navpcla ">23" 以下</a></li>
                        ...
                        <div class="navdivw navco d-flex ndivmar ">
                            <div class="d-flex ">
                                <a href="" class="white navpcla2 pccccc ">輪子</a>
                            </div>
                            <div>
                                <ul class="tip navulw navulleftborder white ">
                                    <li class="navulwli2"><a href="" class="white navpcla ">101A以上 (硬輪)</a></li>
                                    <li class="navulwli2"><a href="" class="white navpcla ">85A - 101A (軟硬輪)</a></li>
                                    <li class="navulwli2"><a href="" class="white navpcla ">85A以下　(軟輪)</a></li>
                                </ul>
                            </div>
                        </div>

                        <div class="navdivw2 d-flex navcor ndivmar   ">
                            <a href="" class="white navaapad navpcla2 navulrightborder">培林</a>
                            <a href="" class="white navaapad navpcla2 navulrightborder">砂紙</a>
                            <div class="navdivw navco d-flex ndivmar ">
                                <div class="d-flex ">
            ...
            <div class=" m-nav row col-xs-12 ">
                    ...
                    <ul class="eeee ">
                        <li class=" justify-content-center">
                            <ul id="sub-menu-3" class="bg-g3 ">
                                ...
                                <li class=" nav-m-listtitli1">
                                    ...
                                    <ul id="sub-menu-3-1" class=" justify-content-center">
                                        ...
                                        <li class="bg-g1 sub-menu-3-1-1 navappl">
                                            <a href="#" class="navbt g4 navapp navhhd">最新商品 </a>
                                        </li>
                                        <li class="bg-g1 sub-menu-3-1-1 navappl">
                                            <a href="#" class="navbt g4 navapp navhhd">人氣商品</a>
                                        </li>
                                        <li class="bg-g1 sub-menu-3-1-1 navappl ">
                                            <button aria-expanded="false" aria-controls="sub-menu-3-1-2"
                                                class="navbt g4 navapp navhhd  m-bbb d-flex justify-content-between m-bbbt"
                                                id="ar-a">
                                                <p>品牌</p> <i class="fas fa-chevron-down ardown"></i>
                                            </button>
                                            <ul class="sub-menu-3-1-2">
                                                <li class="bg-g1 sub-menu-3-1-2 navappl2 navlll  brnavm">
                                                    <a href="#" class="navbt g4 navapp navhhd">
                                                        Almost
                                                    </a>
                                                </li>
                                                <li class="bg-g1 sub-menu-3-1-2 navappl2 navlll brnavm">
                                                ...
                                                <li class="bg-g1 sub-menu-3-1-2 navappl2 navlll brnavm">
                                                    <a href="#" class="navbt g4 navapp navhhdc ">
                                                        Santa Cruz
                                                    </a>
                                                </li>
                                                <li class="bg-g1 sub-menu-3-1-2 navappl2 navlll brnavm">
                                        ...
                                        <li class="bg-g1 sub-menu-3-1-1 navappl">
                                            <button aria-expanded="false" aria-controls="sub-menu-3-2-1"
                                                class="navbt g4 navapp navhhd  m-bbb  m-bbbt d-flex justify-content-between "
                                                id="ar-b">
                                                <p>商品分類</p> <i class="fas fa-chevron-down ardown"></i>
                                            </button>
                                            <ul class="sub-menu-3-2-1 ">
                                                <li class="bg-g1  navappl navlll  brnavm   ">
                                                    <a href="#" class="navbt g4 navapp navvvv ">交通板</a>
                                                    <button aria-expanded="false" aria-controls="sub-menu-3-2-1"
                                                        class="navbt g4 navapp btatt "><i
                                                            class="fas fa-plus navvic "></i></button>
                                                    <ul class="">
                                                        <li class="bg-g1 sub-menu-3-2-1 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 23"
                                                                以下
                                                            </a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-1 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 24"
                                                                ~
                                                                26" </a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-1 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 27"
                                                                ~
                                                                29" </a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-1 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 30"
                                                                以上
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="bg-g1 sub-menu-3-2-2 navappl navlll  brnavm">
                                                    <a href="#" class="navbt g4 navapp navvvv">板身　</a>
                                                    <button aria-expanded="false" aria-controls="sub-menu-3-2-2"
                                                        class="navbt g4 navapp btatt "><i
                                                            class="fas fa-plus navvic "></i></button>
                                                    <ul class="sub-menu-3-2-2">
                                                        <li class="bg-g1 sub-menu-3-2-2 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 7.75"
                                                            </a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-2 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 8" </a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-2 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 8.25"
                                                            </a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-2 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc "> 8.5"
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="bg-g1 sub-menu-3-2-3 navappl navlll  brnavm">
                                                    <a href="#" class="navbt g4 navapp navvvv">輪架　</a>
                                                ...
                                                <li class="bg-g1 sub-menu-3-2-4 navappl navlll  brnavm">
                                                    <a href="#" class="navbt g4 navapp navvvv">輪子　</a>
                                                    <button aria-expanded="false" aria-controls="sub-menu-3-2-4"
                                                        class="navbt g4 navapp btatt"><i
                                                            class="fas fa-plus navvic "></i></button>
                                                    <ul class="sub-menu-3-2-4">
                                                        <li class="bg-g1 sub-menu-3-2-4 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc ">101A 以上
                                                                (硬輪)</a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-4 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc ">85A -
                                                                101A (軟硬輪)</a>
                                                        </li>
                                                        <li class="bg-g1 sub-menu-3-2-4 navp5">
                                                            <a href="#" class="navbt g4 navapp nav321 navhhdc ">85A 以下
                                                                (軟輪)</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="bg-g1  navappl navlll  brnavm"><a href="#"
                                ...
                                <li>
                                <li class="nav-m-listtitli"> <a href="# " class=" nav-m-listtita white">DIY你的滑板</a></li>
                                <li class="nav-m-listtitli"> <a href="#" class=" nav-m-listtita white">最新消息</a></li>
                                <li class="nav-m-listtitli2"> <a href="#" class=" nav-m-listtita white">新手指南</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                <div class="nav-m-logo col-sm-4 col-xs-4 mobile-item-col "><img class="navmlg " src="images/logo.svg"
                        alt=""></div>
                <ul class="col-sm-4 col-xs-4 ml-auto mobile-item-col  mul">
                    ...
                    <li class="mnav-right-li m-circle-num-pos ml-3">
                        ...
                        <i class=" cart-position fas fa-shopping-cart purple">
                ...
                <div class="m-cart-div mt-3">
                    ...
                    <div class="go-pay m-go-pay d-flex justify-content-end"><button class="bt-p">前往結帳</button></div>
                </div>
                </ul>
            </div>
        </div>
    ...
    <script>
        ...
        function checkLoginForm(){
            ...
            $.post('login.php', $('#signIn form').serialize(), function(data){
                ...
                if(data.success){
                    //window.location = 'http://localhost/skate-store/nav.php#';
